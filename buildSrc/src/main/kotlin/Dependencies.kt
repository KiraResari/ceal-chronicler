...
object Dependencies {
    ...
    object Compose {
        ...
        const val material_desktop =
            "androidx.compose.material:material-desktop:${Versions.androidCompose}"
        ...
        const val runtime_livedata =
            "androidx.compose.runtime:runtime-livedata:${Versions.androidCompose}"
        const val foundationLayout =
            "androidx.compose.foundation:foundation-layout:${Versions.androidCompose}"
    }
    ...
    object Moko {
        ...
        const val resourcesCompose =
            "dev.icerock.moko:resources-compose:${Versions.icerockResources}"
    }
